...
import { getBrandEmailTemplate, defaultBrandConfig } from "./brandStyles";
...
export const waitlistConfirmationTemplate: EmailTemplate = {
  ...
  html: getBrandEmailTemplate(
    ...
    `
      ...
      {{#if selectedIdeas}}
      <div style="background: #f8fafc; padding: 20px; border-radius: 8px; margin: 25px 0; border-left: 4px solid ${defaultBrandConfig.primaryColor};">
      ...
      <p>Se você tiver alguma dúvida, nossa equipe está sempre disponível em <a href="mailto:{{supportEmail}}" style="color: ${defaultBrandConfig.primaryColor};">{{supportEmail}}</a>.</p>
...
export const waitlistInviteTemplate: EmailTemplate = {
  ...
  html: getBrandEmailTemplate(
    ...
    `
      ...
      <p>Se você tiver alguma dúvida ou precisar de ajuda, nossa equipe está sempre disponível em <a href="mailto:{{supportEmail}}" style="color: ${defaultBrandConfig.primaryColor};">{{supportEmail}}</a>.</p>
    ...
    `,
    "Sua conta está pronta para criar copies incríveis com IA",
    defaultBrandConfig
  ),
  text: `
