...
export const HooksLibrary = () => {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined' && (window as any).gtag) {
      (window as any).gtag('event', 'hooks_library_viewed', {
        timestamp: Date.now()
      });
    }
  }, []);

  const handleHookUse = (hook: Hook) => {
    // Additional analytics or actions when hook is used
    console.log('Hook used:', hook);
  };
        ...
        <div className="text-center mb-12 max-w-3xl mx-auto">
          <div className="mb-6">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              Escolha um hook testado em campanhas reais e deixe a IA expandir sua copy. 
              Cada abertura foi validada por profissionais de marketing e copywriters experientes.
            </p>
          </div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-primary/5 via-primary/10 to-primary/5 rounded-2xl p-8 border border-primary/20">
            <h3 className="text-2xl font-bold text-foreground mb-4">
              Pronto para criar sua copy matadora?
            </h3>
            <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
              Escolha um hook acima e deixe nossa IA expandir em uma copy completa e persuasiva. 
              Cada hook foi testado e validado em campanhas reais.
            </p>
            <Button 
